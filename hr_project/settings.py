...
SECRET_KEY = 'rmmBlvknx70ek_bBHyfoggrQg5DOqWMgDWbuMR_n0OxiBnKpzArKPOzdrFbLbrf6vRk'  # Change this!

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False  # Change to False for production

ALLOWED_HOSTS = ['itika.pythonanywhere.com', 'localhost', '127.0.0.1']
